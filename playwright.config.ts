...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'chromium',
      testMatch: /smoke\/(authenticated|notifications|onboarding|feed-discover|push-activation)\.spec\.ts|critical\/(people-search|follow-lists|capsule-create-photos)\.spec\.ts/,
      dependencies: ['setup'],
      use: {
