  ...
  switch (type) {
    case 'capsule':
      return {
        ...
        description: 'Cuando alguien a quien sigues publique o dé me gusta a una Capsule, aparecerá aquí.',
      };
    case 'collection':
      return {
        title: 'Sin listas recientes',
        description: 'Cuando creen o den me gusta a una lista pública, aparecerá aquí.',
      };
  }
}
