...
export const appRouter = createBrowserRouter([
  ...
  { path: '/aviso-legal', lazy: () => import('@/pages/LegalNoticePage').then((m) => ({ Component: m.LegalNoticePage })) },
  ...
  { path: '/legal', element: <Navigate to="/aviso-legal" replace /> },
  { path: '/aviso', element: <Navigate to="/aviso-legal" replace /> },
