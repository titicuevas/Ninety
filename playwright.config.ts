...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'chromium',
      testMatch: /smoke\/(authenticated|collections|notifications|onboarding|feed-discover|push-activation|social-engagement|watch-context)\.spec\.ts|critical\/(people-search|follow-lists|capsule-create-photos|capsule-privacy)\.spec\.ts/,
      dependencies: ['setup'],
      use: {
