...
describe('API', () => {
  ...
  it('GET /api/capsules/me/liked requiere auth', async () => {
    const res = await request(createApp()).get('/api/capsules/me/liked');
    assert.equal(res.status, 401);
  });
  ...
  it('GET /api/collections/:id/likes/following requiere auth', async () => {
    const res = await request(createApp()).get(
      '/api/collections/00000000-0000-4000-8000-000000000001/likes/following',
    );
    assert.equal(res.status, 401);
  });

  it('GET /api/collections/:id/comments/following requiere auth', async () => {
    const res = await request(createApp()).get(
      '/api/collections/00000000-0000-4000-8000-000000000001/comments/following',
    );
    assert.equal(res.status, 401);
  });
  ...
  it('GET /api/capsules/:id/likes/following requiere auth', async () => {
    const res = await request(createApp()).get(
      '/api/capsules/00000000-0000-4000-8000-000000000001/likes/following',
    );
    assert.equal(res.status, 401);
  });
